# This is our nonprofit platform 
...
# Tab 1: Chatbot area
with tab1:
    st.markdown("### 💬 AI Community Support Assistant")
    
    col1, col2 = st.columns([2, 1])
    
    with col1:
        st.markdown("*Get instant answers to questions about our programs, services, and how to get involved.*")
        
        # This creates a text box where users can type
        user_question = st.text_input(
            "Ask me anything:", 
            placeholder="Try: 'What are your hours?' or 'How can I volunteer?'"
        )
        ...
        with col_ask:
            if st.button("💬 Ask Assistant", type="primary"):
                ...
                if user_question:
                    # This is our simple "brain" - it looks for keywords and responds
    ...
    with col2:
        ...
        st.markdown("---")
        st.info("💡 **Tip:** Ask natural questions - the AI understands context!")
    ...
    with col1:
        ...
        if uploaded_file is not None:
            try:
                ...
                # Shows the first few rows so they can see what's in the file
